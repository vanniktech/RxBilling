 ...
 */
public final class RxBillingV3 implements RxBilling {
   ...
   */
  @SchedulerSupport(IO) public RxBillingV3(@NonNull final Activity activity) {
   ...
   */
  @SchedulerSupport(CUSTOM) public RxBillingV3(@NonNull final Activity activity, @NonNull final Scheduler scheduler) {
   ...
   */
  @SchedulerSupport(IO) public RxBillingV3(@NonNull final Activity activity, @NonNull final Logger logger) {
   ...
   */
  @SchedulerSupport(IO) public RxBillingV3(@NonNull final Activity activity, final int requestCode) {
  ...
  @Override @NonNull @CheckReturnValue public Observable<InventoryInApp> queryInAppPurchases(@NonNull final String... skuIds) {
    return query(TYPE_INAPP, InventoryInApp.CONVERTER, skuIds);
  }

  @Override @NonNull @CheckReturnValue public Observable<InventorySubscription> querySubscriptions(@NonNull final String... skuIds) {
    return query(TYPE_SUBSCRIPTIONS, InventorySubscription.CONVERTER, skuIds);
  }
              ...
              @Override public void accept(final ActivityResult activityResult) throws Exception {
                ...
                if (data != null) {
                  ...
                  if (activityResult.resultCode() == RESULT_OK) {
                    final PurchaseResponse purchaseResponse = PurchaseResponse.create(json);
  ...
  @Override @NonNull @CheckReturnValue public Observable<PurchasedInApp> getPurchasedInApps() {
    return getPurchased(TYPE_INAPP, PurchasedInApp.CONVERTER);
  }

  @Override @NonNull @CheckReturnValue public Observable<PurchasedSubscription> getPurchasedSubscriptions() {
    return getPurchased(TYPE_SUBSCRIPTIONS, PurchasedSubscription.CONVERTER);
  }
