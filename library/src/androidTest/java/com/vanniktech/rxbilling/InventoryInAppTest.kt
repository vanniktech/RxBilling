...
class InventoryInAppTest {
  @Test fun fromJson() {
    val expected = InventoryInApp.create("exampleSku", "$5.13", 5130000, "USD", "Example Title", "This is an example description")
    assertThat(InventoryInApp.CONVERTER.convert("""
      {
