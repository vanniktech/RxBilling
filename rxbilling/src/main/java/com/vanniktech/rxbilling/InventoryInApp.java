...
@SuppressWarnings("PMD.UseObjectForClearerAPI") @AutoValue public abstract class InventoryInApp implements Inventory {
  @NonNull public static InventoryInApp create(@NonNull final String sku, @NonNull final String type, @NonNull final String price, final int priceAmountMicros, @NonNull final String priceCurrencyCode, @NonNull final String title, @NonNull final String description) {
